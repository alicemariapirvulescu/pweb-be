...
public class GeneralMapperComponent {
    ...
    public BookingDTO bookingToDto(Booking entity){
        return new BookingDTO(entity.getId(),entity.getStartDate(),entity.getEndDate(),
                entity.getGuest().getUsername(),entity.getBookingStatus(),entity.getRentHouse().getName(),
                entity.getRentHouse().getOwner().getUsername(),entity.getRentHouse().getPhone(),entity.getGuestPhone());
    }
